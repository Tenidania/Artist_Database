...
CREATE USER 'teni'@'localhost' IDENTIFIED BY 'password';
GRANT ALL PRIVILEGES ON artist_database.* TO 'teni'@'localhost';
FLUSH PRIVILEGES;
...
-- Dump completed on 2024-12-08 22:58:16
-- MySQL dump 10.13  Distrib 8.0.40, for Linux (x86_64)
--
-- Host: localhost    Database: mysql
-- ------------------------------------------------------
...
-- Dump completed on 2024-12-08 22:58:41
